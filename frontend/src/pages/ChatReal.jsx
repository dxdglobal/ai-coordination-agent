...
export default function Chat() {
  ...
  const predefinedPrompts = [
    ...
    {
      label: 'Project Tasks',
      prompt: 'DDS Focus Pro please show tasks',
      icon: <BarChart />,
      type: 'database'
    },
    {
    ...
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column', bgcolor: '#f5f5f5' }}>
      ...
      <Paper elevation={1} sx={{ p: 2, bgcolor: '#1976d2', color: 'white' }}>
        ...
        <Typography variant="body2" sx={{ textAlign: 'center', opacity: 0.9 }}>
          Connected to Real CRM Database | Universal Employee & Project System
        </Typography>
      </Paper>
        ...
        {showWelcome && (
          <Paper elevation={2} sx={{ p: 3, mb: 3, bgcolor: '#e3f2fd', borderRadius: 3 }}>
            ...
            <Typography variant="body2" sx={{ fontStyle: 'italic', color: '#666' }}>
              💡 Click any chip above or ask about any employee, project, or team performance!
            </Typography>
          </Paper>
        )}
